<script>
    ...
    import { authToken, setAuthToken } from './../stores/authStore.js';
    ...
    async function handleSubmit(event) {
        ...
        const token = await loginAndGetToken(formData)
    ...
    <form id="myform" autocomplete="off" action="/hello" on:submit|preventDefault={handleSubmit}>
        ...
        <footer>
            <div class="btn-field">
                ...
                <button type="submit" id="signupBtn" disabled={!isFormValid}>Log in</button>
            </div>
        </footer>
    </form>
</div>
