<script>
    ...
    import UpButton from '../admin/UpButton.svelte';
    import MainForm from '../formTemp/MainForm.svelte';
    import CrudTable from '../admin/tables/CrudTable.svelte';
    // import almecLogo from '../assets/almec-logo.svg';
    import { formRegister, formLogin, formAdd } from '../stores/formValidationRules.js';
    ...
    onMount(async () => {
        try {
            const response = await fetch(`http://localhost:3000/api/data/fetch/${$userInfo.name}`, {
                headers: {
...
{#if character}
    <header>
        <nav>
            ...
            <ul class="navigation-menu">
                <li><a href="#">Leeggoed aanmelden </a></li>
                <li><a href="#">Aangemeld Leeggoed</a></li>
                <li><a href="#locate">Voorwaarden</a></li>
            ...
            <div id="utility">
                    ...
                    <div class="info">
                        <p>Hey, <b>{character.user.bedrijfsnaam}</b></p>
                        <small class="text-muted">{character.user.roles}</small>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <section>
        <CrudTable dynamicApiUrl="http://localhost:3000/api/data/products/{character.user._id}"/>
    </section>

    <section class="hero" style="display: block">
        <MainForm formData={character} apiUrl="http://localhost:3000/api/data/products" form={formAdd}/>
    </section>

    <section>
        <h1>Voorwaarden en bepalingen</h1>
        <ul>
            <li>Cartridges die defect en/of beschadigd zijn worden niet vergoed.</li>
            <li>Compatible cartridges worden niet vergoed; alleen originele en remanufactured cartridges & toners.</li>
            <li>Zendingen met een totale waarde onder de € 25,- worden niet door ons vergoed i.v.m. de gemaakte kosten voor transport.</li>
            <li>Dozen zonder afzender worden niet in behandeling genomen.</li>
            <li>Alleen voor klanten van ALMEC Supplies BV.</li>
            <li>Creditfactuur ontvangt u binnen maximaal 1 maand in uw mailbox.</li>
        </ul>
    </section>
    <UpButton />
